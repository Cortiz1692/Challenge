...
import { VIEW_DOC_URL_CGS } from "./index.js";
...
export const CGS = () => {
  const { initCGSForm, handlerDocSelectedForm, handlerAddDoc } =
    useContext(DocumentsContext);

  const [userForm, setUserForm] = useState(initCGSForm);
  ...
  const viewDocument = () => {
    ...
    const VIEW_DOC = `${VIEW_DOC_URL_CGS}${certificado}`;
          ...
          <div className="card p-4">
            <div className="mb-2 ">
              <h1 className="col-12 mb-4">
                Certificado Gestion de la Seguridad
              </h1>
              <div className="mb-2">
